 ...
 * 游戏公告
 */
public class BingoWebActivity extends AppCompatActivity implements View.OnClickListener {
...
//                handler.proceed();//注: 忽略证书错误信息将导致无法再play store上架
                final AlertDialog.Builder builder = new AlertDialog.Builder(BingoWebActivity.this, ResourceManager.getAndroidResId(BingoWebActivity.this, "style", "Theme_DeviceDefault_Light_Dialog"));
                builder.setMessage(ResourceManager.getString(BingoWebActivity.this, "bingo_error_ssl_cert_invalid"));
                builder.setPositiveButton(ResourceManager.getString(BingoWebActivity.this, "bingo_common_continue"), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        handler.proceed();
                    }
                });
                builder.setNegativeButton(ResourceManager.getString(BingoWebActivity.this, "bingo_common_dialog_cancel"), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        handler.cancel();
                    }
                    ...
                    try {
                        ...
                        if (intent.resolveActivity(getPackageManager()) != null) {  //存在
                            ...
                            if ("weixin".equals(uri.getScheme())) {
                                ToastUtil.showShortToast(BingoWebActivity.this, "请安装微信客户端后再使用");
                                return false;
//                                finish();
                            }
//
...
//                                }
    ...
    private void setDisable(AppCompatImageView view) {
        view.setColorFilter(ContextCompat.getColor(BingoWebActivity.this, ResourceManager.getColor(this, "color_bingo_gray_disabled")));
